...
project = u'Python Project Proto'
copyright = u'2019, Sergei Chipiga'
...
htmlhelp_basename = 'PythonProjectProtodoc'
...
latex_documents = [
    (master_doc, 'PythonProjectProto.tex', u'Python Project Proto Documentation',
...
man_pages = [
    (master_doc, 'pythonprojectproto', u'Python Project Proto Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PythonProjectProto', u'Python Project Proto Documentation',
     author, 'PythonProjectProto', 'One line description of project.',
     'Miscellaneous'),
]
...
def setup(app):
    ...
    orig_formatargspec = autodoc.formatargspec

    def patched_formatargspec(func):
        if type(func) is not partial:
            func = get_unwrapped_func(func)
        return orig_formatargspec(func)

    autodoc.formatargspec = patched_formatargspec
    ...
    if func.__name__ != func.__code__.co_name:
        for cell in (func.__closure__ or []):
            ...
            if inspect.isfunction(obj):
                if func.__name__ == obj.__code__.co_name:
                    return obj
                else:
